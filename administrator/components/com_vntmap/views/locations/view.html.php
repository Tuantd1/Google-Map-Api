...
/**
 * View class for a list of Vntmap.
 *
 * @since  1.6
 */
class VntmapViewLocations extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		VntmapHelper::addSubmenu('locations');
	...
	protected function addToolbar()
	{
		...
		$canDo = VntmapHelper::getActions();

		JToolBarHelper::title(JText::_('COM_VNTMAP_TITLE_LOCATIONS'), 'locations.png');
		...
		{
			JToolBarHelper::preferences('com_vntmap');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_vntmap&view=locations');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_VNTMAP_LOCATIONS_TITLE'),
		);
	}
