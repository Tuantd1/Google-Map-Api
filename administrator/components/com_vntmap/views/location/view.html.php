 ...
 * @since  1.6
 */
class VntmapViewLocation extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_VNTMAP_TITLE_LOCATION'), 'location.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_vntmap.location', $this->item->id);
		}
