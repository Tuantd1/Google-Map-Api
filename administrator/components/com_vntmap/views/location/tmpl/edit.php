...
$document->addStyleSheet(JUri::root() . 'media/com_vntmap/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_vntmap&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="location-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_VNTMAP_TITLE_LOCATION', true)); ?>
		<div class="row-fluid">
